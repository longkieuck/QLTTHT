...
BEGIN
	...
	SET @SOLOP=(SELECT COUNT(*)
				FROM HOCVIEN_LOPHOC
			    WHERE MaHV in(SELECT MAHV FROM INSERTED)
				)
...
ON HOCVIEN_LOPHOC AFTER DELETE
AS
BEGIN
...
BEGIN
	...
	INSERT INTO BIENLAITRALUONG VALUES(null,@THANGHT,0,0,@MAGV)
END
GO
...
BEGIN
	...
	INSERT INTO BIENLAITRALUONG VALUES(null,@THANGMOI,0,0,@magv)
